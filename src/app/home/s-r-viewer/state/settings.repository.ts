...
export class SettingsRepository {
  ...
  private store = createStore({ name: SettingsRepository.NAME }, withProps<FullSettings>({
  ...
  setSettings(opts: FullSettings, extra: {emitEvent: boolean} = {emitEvent: true}) {
  ...
  setActiveCategory(category: string) {
    this.store.update(setProp("category", state => ({...state, current: category})));
  }
